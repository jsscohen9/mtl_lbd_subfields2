...
```{r initialize}
# input
file_name <- c("objects/ashs_summed_regions.RDS") # start with just cases and controls, without adjustment for ICV 
...
ds %<>% select(1:11, contains(c("bilat", "biat")) & !contains("adjusted"), "left_icv",
              -c("bilat_erc", "bilat_br_35", "bilat_br_36", "bilat_phc", "hippo_median_thk_bilateral"))
...
ds %>% dlookr::diagnose() %>%  arrange(("missing_percent"))
...
ds$ad_marker <- factor(ds$ad_marker,
                          ...
                          labels = c("Autopsy", "Autopsy", "PET", "CSF"))
...
```{r}
# Plot Correlation of volumes with csf measures 
  csf_cases %<>% janitor::clean_names() 

# Match csf_cases to ds by inddid then select the CSFDate closest to session_date
  ds_csf <- ds %>% left_join(csf_cases) %>%
  ...
  # Fit a linear regression model to the volume and CSF ttau
mod_full_hipp <- lm(bilat_full_hippocamp ~ ttau*ad_present + age_at_mri + sex + left_icv + date_diff_csf, data = ds_csf)
  summary(mod_full_hipp)

# Plot volume by ttau
ggplot(data = ds_csf, aes(x = ttau, y = bilat_full_hippocamp, color = ad_present)) +
  geom_jitter(alpha = 0.6) +
  geom_smooth(method = "lm") +
  labs(x = "ttau", y = "Volume (mm^3)", title = "Whole Hippocampus")

# Ant Hipp
mod_ant_hipp <- lm(bilat_ant_hippocamp ~ ttau*ad_present + age_at_mri + sex + left_icv + date_diff_csf, ds_csf)
  summary(mod_ant_hipp)

# Plot volume by ttaa
ggplot(data = ds_csf, aes(x = ttau, y = bilat_ant_hippocamp, color = ad_present)) +
  geom_jitter(alpha = 0.6) +
  geom_smooth(method = "lm") +
  labs(x = "ttau", y = "Volume (mm^3)", title = "Anterior Hippocampus") 

# Post Hipp
mod_post_hipp <- lm(bilat_post_hippocamp ~ ttau*ad_present + age_at_mri + sex + left_icv + date_diff_csf, ds_csf)
  summary(mod_post_hipp)

# Plot vol by ttau
ggplot(data = ds_csf, aes(x = ttau, y = bilat_post_hippocamp, color = ad_present)) +
  geom_jitter(alpha = 0.6) +
  geom_smooth(method = "lm") +
  labs(x = "ttau", y = "Volume (mm^3)", title = "Posterior Hippocampus")


# ERC
mod_erc <- lm(erc_median_thk ~ ttau*ad_present + age_at_mri + sex + left_icv + date_diff_csf, ds_csf)
  summary(mod_erc)

# Plot thk by ttau, 
ggplot(data = ds_csf, aes(x = ttau, y = erc_median_thk_bilateral, color = ad_present)) +
  geom_jitter(alpha = 0.6) +
  geom_smooth(method = "lm") +
  labs(x = "ttau", y = "Thickness (mm)", title = "Entorhinal Cortex")

# BA35
mod_ba35 <- lm(ba35_median_thk_biateral ~ ttau*ad_present + age_at_mri + sex + left_icv + date_diff_csf, ds_csf)
  summary(mod_ba35)

# Plot thk by ttau, include r-squared and p value
ggplot(data = ds_csf, aes(x = ttau, y = ba35_median_thk_biateral, color = ad_present)) +
  geom_jitter(alpha = 0.6) +
  geom_smooth(method = "lm") +
  labs(x = "ttau", y = "Thickness (mm)", title = "BA35")

# BA36
mod_ba36 <- lm(ba36_median_thk_biateral ~ ttau*ad_present + age_at_mri + sex + left_icv + date_diff_csf, ds_csf)
  summary(mod_ba36)

# Plot w-scores by ttau, include r-squared and p value
ggplot(data = ds_csf, aes(x = ttau, y = ba36_median_thk_biateral, color = ad_present)) +
  geom_jitter(alpha = 0.6) +
  geom_smooth(method = "lm") +
  labs(x = "ttau", y = "Thickness (mm)", title = "BA36") 

# PHC
mod_phc <- lm(phc_median_thk_biateral ~ ttau*ad_present + age_at_mri + sex + left_icv + date_diff_csf, ds_csf)
  summary(mod_phc)

# Plot w-scores by ttau, include r-squared and p value
ggplot(data = ds_csf, aes(x = ttau, y = phc_median_thk_biateral, color = ad_present)) +
  geom_jitter(alpha = 0.6) +
  geom_smooth(method = "lm") +
  labs(x = "ttau", y = "Thickness (mm)", title = "PHC")

```

```{r}
# Repeat for abeta correlation with volumes

# Fit a linear regression model to the volume and CSF ttau
mod_full_hipp <- lm(bilat_full_hippocamp ~ abeta42*ad_present + age_at_mri + sex + left_icv + date_diff_csf, data = ds_csf)
  summary(mod_full_hipp)

# Plot volume by abeta42
ggplot(data = ds_csf, aes(x = abeta42, y = bilat_full_hippocamp, color = ad_present)) +
  geom_jitter(alpha = 0.6) +
  geom_smooth(method = "lm") +
  labs(x = "abeta42", y = "Volume (mm^3)", title = "Whole Hippocampus")

# Ant Hipp
mod_ant_hipp <- lm(bilat_ant_hippocamp ~ abeta42*ad_present + age_at_mri + sex + left_icv + date_diff_csf, ds_csf)
  summary(mod_ant_hipp)

# Plot volume by abeta42
ggplot(data = ds_csf, aes(x = abeta42, y = bilat_ant_hippocamp, color = ad_present)) +
  geom_jitter(alpha = 0.6) +
  geom_smooth(method = "lm") +
  labs(x = "abeta42", y = "Volume (mm^3)", title = "Anterior Hippocampus") 

# Post Hipp
mod_post_hipp <- lm(bilat_post_hippocamp ~ abeta42*ad_present + age_at_mri + sex + left_icv + date_diff_csf, ds_csf)
  summary(mod_post_hipp)

# Plot vol by abeta42
ggplot(data = ds_csf, aes(x = abeta42, y = bilat_post_hippocamp, color = ad_present)) +
  geom_jitter(alpha = 0.6) +
  geom_smooth(method = "lm") +
  labs(x = "abeta42", y = "Volume (mm^3)", title = "Posterior Hippocampus")

# ERC
mod_erc <- lm(erc_median_thk_bilateral ~ abeta42*ad_present + age_at_mri + sex + left_icv + date_diff_csf, ds_csf)
  summary(mod_erc)

# Plot thk by abeta42, 
ggplot(data = ds_csf, aes(x = abeta42, y = erc_median_thk_bilateral, color = ad_present)) +
  geom_jitter(alpha = 0.6) +
  geom_smooth(method = "lm") +
  labs(x = "abeta42", y = "Thickness (mm)", title = "Entorhinal Cortex")

# BA35
mod_ba35 <- lm(ba35_median_thk_biateral ~ abeta42*ad_present + age_at_mri + sex + left_icv + date_diff_csf, ds_csf)
  summary(mod_ba35)

# Plot thk by abeta42, include r-squared and p value
ggplot(data = ds_csf, aes(x = abeta42, y = ba35_median_thk_biateral, color = ad_present)) +
  geom_jitter(alpha = 0.6) +
  geom_smooth(method = "lm") +
  labs(x = "abeta42", y = "Thickness (mm)", title = "BA35")

# BA36
mod_ba36 <- lm(ba36_median_thk_biateral ~ abeta42*ad_present + age_at_mri + sex + left_icv + date_diff_csf, ds_csf)
  summary(mod_ba36)

# Plot w-scores by abeta42, include r-squared and p value
ggplot(data = ds_csf, aes(x = abeta42, y = ba36_median_thk_biateral, color = ad_present)) +
  geom_jitter(alpha = 0.6) +
  geom_smooth(method = "lm") +
  labs(x = "abeta42", y = "Thickness (mm)", title = "BA36") 

# PHC
mod_phc <- lm(phc_median_thk_biateral ~ abeta42*ad_present + age_at_mri + sex + left_icv + date_diff_csf, ds_csf)
  summary(mod_phc)

# Plot w-scores by abeta42, include r-squared and p value
ggplot(data = ds_csf, aes(x = abeta42, y = phc_median_thk_biateral, color = ad_present)) +
  geom_jitter(alpha = 0.6) +
  geom_smooth(method = "lm") +
  labs(x = "abeta42", y = "Thickness (mm)", title = "PHC")
```
...
fit <- lm(bilat_full_hippocamp ~ ad_present + age_at_mri + sex + education, data = ds)
...
#                  y_label = "Age-sex-ICV-adjusted Volume (mm^3)")
```
...
abbreviations <- c(
 # "bilat_full_hippocamp" = "Whole Hippocampus Volume (mm^3)",
 # "bilat_ant_hippocamp" = "Anterior Hippocampus Volume (mm^3)",
 # "bilat_post_hippocamp" = "Posterior Hippocampus Volume (mm^3)",
  "erc_median_thk_bilateral" = "Median Thickness (mm)",
  "ba35_median_thk_biateral" = "Median Thickness (mm)",
  "ba36_median_thk_biateral" = "Median Thickness (mm)",
  "phc_median_thk_biateral" = "Median Thickness (mm)"
)
...
abbreviations <- c(
 ...
 # "bilat_ant_hippocamp" = "Anterior Hippocampus Volume (mm^3)",
 # "bilat_post_hippocamp" = "Posterior Hippocampus Volume (mm^3)",
  "erc_median_thk_bilateral" = "Entorhinal Cortex Median Thickness (mm)",
  "ba35_median_thk_biateral" = "Brodmann Area 35 Median Thickness (mm)",
  "ba36_median_thk_biateral" = "Brodmann Area 36 Median Thickness (mm)",
  "phc_median_thk_biateral" = "Parahippocampal Cortex Median Thickness (mm)"
)
...
# Fit the linear model for each response variable
models <- lapply(regions, fit_lm, data = ds)
names(models) <- regions # Set the names of the list to the region names
...
```{r}
# Fit the linear regression model
fit <- lm(bilat_full_hippocamp ~ ad_present + age_at_mri + sex + left_icv, data = ds)
...
# Anterior
fit <- lm(bilat_ant_hippocamp ~ ad_present + age_at_mri + sex + left_icv, data = ds)
...
ggplot_the_response(fit, fit_emm = emm1$emmeans, fit_pairs = emm1$contrasts, 
  ...
  theme_gray() +
  theme(text = element_text(size = 24), legend.position = "none") +
  labs(title = "Anterior Hippocampus")
...
# Posterior
fit <- lm(bilat_post_hippocamp ~ ad_present + age_at_mri + sex + left_icv, data = ds)
...
ggplot_the_response(fit, fit_emm = emm1$emmeans, fit_pairs = emm1$contrasts, 
  ...
  theme_gray() +
  theme(text = element_text(size = 24), legend.position = "none") +
  labs(title = "Posterior Hippocampus")

# ERC 
fit <- lm(erc_median_thk_bilateral ~ ad_present + age_at_mri + sex, data = ds)
...
ggplot_the_response(fit, fit_emm = emm1$emmeans, fit_pairs = emm1$contrasts, 
                    y_label = "Age-sex-adjusted Thickness (mm)",
                    x_label = "") + 
  panel_border() +
  geom_violin(aes(fill = ad_present), alpha = 0.5, trim = FALSE) +
  scale_fill_manual(values = c("#0072B2", "#009E73")) +
...
# BA35
fit <- lm(ba35_median_thk_biateral ~ ad_present + age_at_mri + sex, data = ds)
...
# BA36
fit <- lm(ba36_median_thk_biateral ~ ad_present + age_at_mri + sex + left_icv, data = ds)
...
# PHC
fit <- lm(phc_median_thk_biateral ~ ad_present + age_at_mri + sex, data = ds)
...
ggplot_the_response(fit, fit_emm = emm1$emmeans, fit_pairs = emm1$contrasts, 
  ...
  theme_gray() +
  theme(text = element_text(size = 24), legend.position = "none") +
    labs(title = "Parahippocampal Cortex")
...
# Define a function to fit the linear model for each response variable
fit_lm <- function(response_var, data, weights) {
  formula <- as.formula(paste(response_var, "~ ad_present + age_at_mri + sex"))
  lm(formula, data = data)
}
...
# Arrange plots
grid.arrange(grobs = emmeans_results, ncol = 4)
